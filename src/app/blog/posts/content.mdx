---
title: "Portfolio"
summary: "Personalize the portfolio"
...
Replace the `public/images/arun.JPG` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
